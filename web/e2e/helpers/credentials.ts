...
export type RoleKey = 'admin' | 'manager' | 'supervisor' | 'driver' | 'viewer' | 'finance';
...
const roleEnvMap: Record<RoleKey, { identifiers: string[]; passwords: string[] }> = {
  ...
  manager: {
    identifiers: ['E2E_MANAGER_IDENTIFIER', 'MANAGER_USERNAME'],
    passwords: ['E2E_MANAGER_PASSWORD', 'MANAGER_PASSWORD'],
  },
  supervisor: {
    identifiers: ['E2E_SUPERVISOR_IDENTIFIER', 'SUPERVISOR_USERNAME'],
    passwords: ['E2E_SUPERVISOR_PASSWORD', 'SUPERVISOR_PASSWORD'],
  },
  driver: {
    identifiers: ['E2E_DRIVER_IDENTIFIER', 'DRIVER_USERNAME'],
    passwords: ['E2E_DRIVER_PASSWORD', 'DRIVER_PASSWORD'],
  },
  viewer: {
    identifiers: ['E2E_VIEWER_IDENTIFIER', 'VIEWER_USERNAME'],
    passwords: ['E2E_VIEWER_PASSWORD', 'VIEWER_PASSWORD'],
  },
  finance: {
    identifiers: ['E2E_FINANCE_IDENTIFIER', 'FINANCE_USERNAME'],
