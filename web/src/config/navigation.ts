...
export const navigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    path: '/finance',
    description: 'Finance overview and P&L reports',
    permissionKeys: ['finance_view'],
    section: 'MANAGE',
    pageTitle: 'Finance Dashboard',
    pageDescription: 'Financial overview, income, expenses, and profit & loss',
  },
  {
    label: 'Transactions',
    path: '/finance/transactions',
    description: 'Finance transactions',
    permissionKeys: ['finance_transactions_view'],
    section: 'MANAGE',
    pageTitle: 'Transactions',
    pageDescription: 'Track and manage finance transactions',
  },
  {
    label: 'Accounts',
    ...
    section: 'MANAGE',
    pageTitle: 'Accounts',
    pageDescription: 'Manage cash, bank, and wallet accounts',
  },
  {
    label: 'Categories',
    ...
    pageDescription: 'Income and expense categories',
  },
  {
    label: 'Vendors',
    path: '/finance/vendors',
    description: 'Vendor management',
    permissionKeys: ['vendors_view'],
    section: 'MANAGE',
    pageTitle: 'Vendors',
    pageDescription: 'Manage vendor contacts and details',
  },
  {
    label: 'Customers',
    ...
    section: 'MANAGE',
    pageTitle: 'Customers',
    pageDescription: 'Manage customer contacts and billing details',
  },
  {
    label: 'Trip Billing',
    path: '/finance/trip-billings',
    description: 'Trip billing and invoicing',
    permissionKeys: ['trip_billing_view'],
    section: 'MANAGE',
    pageTitle: 'Trip Billing',
    pageDescription: 'Create and manage trip invoices',
  },
  {
    label: 'Payments',
    ...
    section: 'MANAGE',
    pageTitle: 'Payments',
    pageDescription: 'Track incoming and outgoing payments',
  },
  {
    label: 'Roles',
    path: '/roles',
