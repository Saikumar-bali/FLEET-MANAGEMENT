...
const DriverAdvancesPage = lazy(() => import('../pages/driver-portal/DriverAdvancesPage').then(m => ({ default: m.DriverAdvancesPage })));
                ...
                <Route element={<ProtectedRoute />}>
                  <Route element={<AppLayout />}>
                    ...
                    <Route element={<FinanceLayout />}>
                      ...
                      <Route element={<ProtectedRoute requiredPermissions={['driver_settlement_view']} />}>
                        <Route path="/finance/driver-settlements" element={<Suspense fallback={<Loading />}><FinanceDriverSettlementsPage /></Suspense>} />
                      </Route>
                      ...
                      <Route element={<ProtectedRoute requiredPermissions={['finance_view', 'pnl_view']} />}>
                        <Route path="/finance/reports" element={<Suspense fallback={<Loading />}><FinanceReportsPage /></Suspense>} />
                      </Route>
                    </Route>
                    ...
                    <Route element={<DriverPortalLayout />}>
                      ...
                      <Route path="/driver-portal/advances" element={<Suspense fallback={<Loading />}><DriverAdvancesPage /></Suspense>} />
