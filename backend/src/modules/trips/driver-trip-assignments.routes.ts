...
router.post('/me/driver-trip-assignments/:id/confirm', requirePermission('driver_trip_start'), asyncHandler(driverAcceptTripAssignmentController));
router.post('/me/driver-trip-assignments/:id/decline', requirePermission('driver_trip_cancel'), asyncHandler(driverRejectTripAssignmentController));
