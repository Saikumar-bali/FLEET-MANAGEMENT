...
export async function createMyTripController(req: Request, res: Response) {
  ...
  await createAuditLog(req, {
    ...
    metadata: { tripNumber: result.tripNumber },
  });
...
export async function startMyTripController(req: Request, res: Response) {
  ...
  await createAuditLog(req, { userId: req.authUser?.id, action: 'driver.trip.start', entityType: 'trip', entityId: trip.id });
...
export async function endMyTripController(req: Request, res: Response) {
  ...
  await createAuditLog(req, { userId: req.authUser?.id, action: 'driver.trip.end', entityType: 'trip', entityId: trip.id });
...
export async function cancelMyTripController(req: Request, res: Response) {
  ...
  await createAuditLog(req, { userId: req.authUser?.id, action: 'driver.trip.cancel', entityType: 'trip', entityId: trip.id });
...
export async function createMyFuelEntryController(req: Request, res: Response) {
  ...
  await createAuditLog(req, { userId: req.authUser?.id, action: 'driver.fuel.create', entityType: 'fuel_entry', entityId: result.id });
...
export async function createMyExpenseController(req: Request, res: Response) {
  ...
  await createAuditLog(req, { userId: req.authUser?.id, action: 'driver.expense.create', entityType: 'expense', entityId: result.id });
...
export async function createMyMaintenanceReportController(req: Request, res: Response) {
  ...
  await createAuditLog(req, { userId: req.authUser?.id, action: 'driver.maintenance.create', entityType: 'maintenance_request', entityId: result.id });
...
export async function createMyRepairReportController(req: Request, res: Response) {
  ...
  await createAuditLog(req, { userId: req.authUser?.id, action: 'driver.repair.create', entityType: 'repair', entityId: result.id });
