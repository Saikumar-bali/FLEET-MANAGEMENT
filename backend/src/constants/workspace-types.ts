...
export const NAV_ITEMS: NavItemDef[] = [
  ...
  { id: 'finance-dashboard', label: 'Finance', path: '/finance', icon: 'FinanceDashboard', section: 'FINANCE', priority: 300 },
  { id: 'driver-advances', label: 'Driver Advances', path: '/finance/driver-advances', icon: 'FinanceDashboard', section: 'FINANCE', priority: 310 },
  { id: 'driver-settlements', label: 'Driver Settlements', path: '/finance/driver-settlements', icon: 'FinanceDashboard', section: 'FINANCE', priority: 320 },
  { id: 'finance-transactions', label: 'Transactions', path: '/finance/transactions', icon: 'Transactions', section: 'FINANCE', priority: 330 },
  { id: 'finance-accounts', label: 'Accounts', path: '/finance/accounts', icon: 'Accounts', section: 'FINANCE', priority: 340 },
  { id: 'finance-categories', label: 'Categories', path: '/finance/categories', icon: 'FinanceDashboard', section: 'FINANCE', priority: 350 },
  { id: 'finance-vendors', label: 'Vendors', path: '/finance/vendors', icon: 'Vendors', section: 'FINANCE', priority: 360 },
  { id: 'finance-customers', label: 'Customers', path: '/finance/customers', icon: 'Customers', section: 'FINANCE', priority: 370 },
  { id: 'pod-chain', label: 'POD Chain', path: '/finance/pod-chain', icon: 'Documents', section: 'FINANCE', priority: 380 },
  { id: 'payment-closure', label: 'Payment Closure', path: '/finance/payments?view=closure', icon: 'Payments', section: 'FINANCE', priority: 390 },
  { id: 'trip-billing', label: 'Trip Billing', path: '/finance/trip-billings', icon: 'Billing', section: 'FINANCE', priority: 400 },
  { id: 'payments', label: 'Payments', path: '/finance/payments', icon: 'Payments', section: 'FINANCE', priority: 410 },
