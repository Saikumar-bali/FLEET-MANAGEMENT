...
export const permissionDefinitions: PermissionDefinition[] = [
  ...
  { key: 'staff_wallet_view', module: 'finance', action: 'view', description: 'View staff wallets and custody ledger' },
  { key: 'staff_advance_manage', module: 'finance', action: 'manage', description: 'Create and submit staff advances' },
  { key: 'staff_advance_approve', module: 'finance', action: 'approve', description: 'Approve staff advances' },
  { key: 'staff_advance_fund', module: 'finance', action: 'fund', description: 'Disburse approved staff advances' },
  { key: 'staff_settlement_manage', module: 'finance', action: 'manage', description: 'Create and submit staff settlements' },
  { key: 'staff_settlement_approve', module: 'finance', action: 'approve', description: 'Approve staff settlements' },
  { key: 'staff_settlement_cashier', module: 'finance', action: 'cashier', description: 'Confirm returned cash and close settlements' },
  { key: 'finance_reconcile', module: 'finance', action: 'reconcile', description: 'Reconcile incoming and outgoing payments' },
  { key: 'allowance_policy_manage', module: 'finance', action: 'manage', description: 'Manage trip allowance policies' },
  { key: 'staff_wallet_view_own', module: 'staff_portal', action: 'view_own', description: 'View own wallet, advances and settlements' },
...
export const defaultRolePermissionMap: Record<string, string[]> = {
  ...
  manager: [
    ...
    'staff_wallet_view',
    'staff_advance_approve',
    'staff_settlement_approve',
    'staff_settlement_cashier',
  ],
  supervisor: [
    'dashboard_view',
    'vehicle_view',
  ...
  finance: [
    ...
    'report_export',
    'staff_wallet_view',
    'staff_advance_manage',
    'staff_advance_approve',
    'staff_advance_fund',
    'staff_settlement_manage',
    'staff_settlement_approve',
    'staff_settlement_cashier',
    'finance_reconcile',
    'allowance_policy_manage',
    'staff_wallet_view_own',
  ],
  viewer: [
    'dashboard_view',
