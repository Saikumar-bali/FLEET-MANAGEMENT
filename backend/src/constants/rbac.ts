...
export const defaultRolePermissionMap: Record<string, string[]> = {
  ...
  mechanic: ['repair_view', 'repair_update', 'repair_close', 'maintenance_view', 'maintenance_update', 'vehicle_compliance_view', 'vehicle_compliance_create', 'vehicle_compliance_update', 'document_metadata_view', 'compliance_history_view'],
  finance: [
    'finance_view',
    'finance_create',
    'finance_update',
