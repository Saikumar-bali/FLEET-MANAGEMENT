...
- Identified running backend Node/nodemon processes as the Windows Prisma DLL lock cause.
- Stopped Node processes before Prisma generation and backend build.
