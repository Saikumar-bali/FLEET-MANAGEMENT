...
- `backend/src/modules/dashboard/dashboard.service.ts` (updated - document aggregates)
...
- `backend/scripts/storage-provider-test.ts` (new - R2 provider integration test)
- `backend/scripts/r2-test.ts` (new - direct SDK test)
- `backend/package.json` (updated)
- `backend/.gitignore` (updated)

### Frontend
- `web/src/pages/DocumentsPage.tsx` (new)
- `web/src/components/documents/LinkedDocumentsPanel.tsx` (new - reusable panel for entity detail tabs)
...
- `web/src/pages/VehicleDetailPage.tsx` (updated - Documents tab with LinkedDocumentsPanel)
- `web/src/pages/DriverDetailPage.tsx` (updated - Documents tab with LinkedDocumentsPanel)
- `web/src/pages/TripDetailPage.tsx` (updated - Documents tab with LinkedDocumentsPanel)
- `web/src/pages/DashboardPage.tsx` (updated - document KPI widgets, recent documents table)
